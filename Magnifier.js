window.onload = function() {
	...
	var mask = document.querySelector("#small .mask");
	...
	small.onmousemove = function(e) {
		...
		var l = e.clientX - mask.offsetWidth / 2 - small.offsetLeft;
		var t = e.clientY - mask.offsetHeight / 2 - small.offsetTop;
		 ...
		 */
		var scaleX = l / (small.offsetWidth - mask.offsetWidth);
		var scaleY = t / (small.offsetHeight - mask.offsetHeight);
